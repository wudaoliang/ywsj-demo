        ...
        add_node:function(parent_node, nodeid, topic, data, direction){
            ...
            if(this.get_editable()){
                ...
                if(!!node){
                    ...
                    this.invoke_event_handle(jm.event_type.edit,{evt:'add_node',data:[parent_node.id,nodeid,topic,data,node.direction],node:nodeid});
                }
                return node;
            }else{
                logger.error('fail, this mind map is not editable');
        ...
        insert_node_after:function(node_after, nodeid, topic, data){
            if(this.get_editable()){
                ...
                if(!!node){
                    ...
                    this.layout.layout();
                    this.view.show(false);
                    this.invoke_event_handle(jm.event_type.edit,{evt:'insert_node_after',data:[node_after.id,nodeid,topic,data,node.direction],node:nodeid});
                }
                return node;
            }else{
                logger.error('fail, this mind map is not editable');
